# Copyright 1999-2011 W-Mark Kubacki
...
PHP_PATCHSET_URI="http://dev.gentoo.org/~hoffie/distfiles/php-patchset-5.2.17-r${PHP_PATCHSET_REV}.tar.bz2"
SUHOSIN_PATCH="suhosin-patch-5.2.16-0.9.7.patch.gz"
FPM_PATCH="php-${MY_PHP_PV}-fpm-0.5.14.diff"
