...
HTTP_HEADERS_MORE_MODULE_PV="0.24"
HTTP_HEADERS_MORE_MODULE_SHA1="7a6fd11"
...
HTTP_ECHO_MODULE_PV="0.50"
HTTP_ECHO_MODULE_SHA1="f827a4f"
...
HTTP_SET_MISC_MODULE_PV="0.23"
HTTP_SET_MISC_MODULE_SHA1="6ce586e"
...
src_prepare() {
	...
	epatch "${FILESDIR}/0002-SSL-support-ALPN-IETF-s-successor-to-NPN.patch"
	epatch "${FILESDIR}/0003-SSL-ssl_buffer_size-directive.patch"
	...
	if use nginx_modules_http_lua; then
		...
		epatch "${FILESDIR}/nginx-1.5.8-lua-nginx-module-0.9.3-resolver-fix.patch"
		cd -
	fi
