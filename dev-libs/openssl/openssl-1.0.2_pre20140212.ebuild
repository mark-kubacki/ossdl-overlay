...
IUSE="bindist +cryptodev gmp kerberos rfc3779 sse2 +weaker-nist800-131 static-libs test +tls-heartbeat vanilla zlib"
...
src_prepare() {
	...
	if ! use vanilla ; then
		...
		epatch "${FILESDIR}"/0001-Fixes-install-with-perl-5.18.patch #483820
		epatch "${FILESDIR}"/${PN}-1.0.1e-s_client-verify.patch #472584
		epatch_user #332661
	fi

	if use weaker-nist800-131 ; then
		# enforces low security standards (default: enforce nothing)
